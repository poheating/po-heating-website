...
const BolierServicesHero = () => {
    const t = useTranslations('BoilerServices.Hero');
        ...
        <div className={styles.page}>
            <div className={styles.content}>
                <div className={styles.pageHeading}>
                    ...
                    <h2>{t('title.part1')} <motion.span
                        initial={{ color: '#303030' }}
                        whileInView={{ color: '#ff6600' }}
                        transition={{ duration: 0.6, type: 'spring', delay: 0.4 }}
                        viewport={{ once: true }}>{t('title.span')}</motion.span> {t('title.part2')}</h2>
                </div>
                <Image priority sizes="(max-width: 768px) 100vw, 1920px" src={'/images/boiler-page-hero.webp'} width={1300} height={1300} alt={t('imageAlt')} />
